    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          <p className="mb-3 font-semibold md:mb-4 text-black-olive-200 uppercase">
          ...
          <p className="md:text-md">{en.home.solutions.description}</p>
        </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-2">
            {cards.map((card, index) => (
              <div key={index} className="flex flex-col items-stretch ">
                ...
                <div className="block flex-1 flex-col items-stretch justify-center p-6 md:flex md:p-8 lg:p-12 bg-white">
                  <div>
                    <p className="mb-2 font-light italic font-serif">
                      {card.tagline}
                    </p>
                    <h3 className="font-serif mb-5 text-4xl font-semibold leading-[1.2] md:mb-6 md:text-5xl lg:text-6xl">
                      {card.heading}
                    </h3>
